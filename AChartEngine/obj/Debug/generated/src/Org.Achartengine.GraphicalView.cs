		...
		public virtual global::Org.Achartengine.Model.SeriesSelection CurrentSeriesAndPoint {
			...
			get {
				...
				if (GetType () == ThresholdType)
					...
					return global::Java.Lang.Object.GetObject<global::Org.Achartengine.Model.SeriesSelection> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getCurrentSeriesAndPoint", "()Lorg/achartengine/model/SeriesSelection;")), JniHandleOwnership.TransferLocalRef);
			}
		}
		...
		protected virtual global::Android.Graphics.RectF ZoomRectangle {
			...
			get {
				...
				if (GetType () == ThresholdType)
					...
					return global::Java.Lang.Object.GetObject<global::Android.Graphics.RectF> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getZoomRectangle", "()Landroid/graphics/RectF;")), JniHandleOwnership.TransferLocalRef);
			}
		}
...
#pragma warning restore 0169
		...
		public virtual void AddPanListener (global::Org.Achartengine.Tools.IPanListener p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "addPanListener", "(Lorg/achartengine/tools/PanListener;)V"), new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public virtual void AddZoomListener (global::Org.Achartengine.Tools.IZoomListener p0, bool p1, bool p2)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "addZoomListener", "(Lorg/achartengine/tools/ZoomListener;ZZ)V"), new JValue (p0), new JValue (p1), new JValue (p2));
		}
...
#pragma warning restore 0169
		...
		public virtual void RemovePanListener (global::Org.Achartengine.Tools.IPanListener p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "removePanListener", "(Lorg/achartengine/tools/PanListener;)V"), new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public virtual void RemoveZoomListener (global::Org.Achartengine.Tools.IZoomListener p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "removeZoomListener", "(Lorg/achartengine/tools/ZoomListener;)V"), new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public virtual void Repaint ()
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "repaint", "()V"));
		}
...
#pragma warning restore 0169
		...
		public virtual void Repaint (int p0, int p1, int p2, int p3)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "repaint", "(IIII)V"), new JValue (p0), new JValue (p1), new JValue (p2), new JValue (p3));
		}
...
#pragma warning restore 0169
		...
		public virtual void SetZoomRate (float p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setZoomRate", "(F)V"), new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public virtual global::Android.Graphics.Bitmap ToBitmap ()
		{
			...
			if (GetType () == ThresholdType)
				...
				return global::Java.Lang.Object.GetObject<global::Android.Graphics.Bitmap> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "toBitmap", "()Landroid/graphics/Bitmap;")), JniHandleOwnership.TransferLocalRef);
		}
...
#pragma warning restore 0169
		...
		public virtual double[] ToRealPoint (int p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				return (double[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "toRealPoint", "(I)[D"), new JValue (p0)), JniHandleOwnership.TransferLocalRef, typeof (double));
		}
...
#pragma warning restore 0169
		...
		public virtual void ZoomReset ()
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "zoomReset", "()V"));
		}
