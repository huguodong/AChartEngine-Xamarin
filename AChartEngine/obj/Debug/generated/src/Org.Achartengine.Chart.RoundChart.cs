		...
		public virtual int CenterX {
			...
			set {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setCenterX", "(I)V"), new JValue (value));
			}
		}
		...
		public virtual int CenterY {
			...
			set {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setCenterY", "(I)V"), new JValue (value));
			}
		}
