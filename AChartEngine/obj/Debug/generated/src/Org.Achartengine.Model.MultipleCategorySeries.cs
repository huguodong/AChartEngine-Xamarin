		...
		public virtual int CategoriesCount {
			...
			get {
				...
				if (GetType () == ThresholdType)
					...
					return JNIEnv.CallNonvirtualIntMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getCategoriesCount", "()I"));
			}
		}
...
#pragma warning restore 0169
		...
		public virtual void Add (string p0, string[] p1, double[] p2)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "add", "(Ljava/lang/String;[Ljava/lang/String;[D)V"), new JValue (native_p0), new JValue (native_p1), new JValue (native_p2));
			JNIEnv.DeleteLocalRef (native_p0);
			if (p1 != null) {
...
#pragma warning restore 0169
		...
		public virtual void Add (string[] p0, double[] p1)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "add", "([Ljava/lang/String;[D)V"), new JValue (native_p0), new JValue (native_p1));
			if (p0 != null) {
...
#pragma warning restore 0169
		...
		public virtual string GetCategory (int p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				return JNIEnv.GetString (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getCategory", "(I)Ljava/lang/String;"), new JValue (p0)), JniHandleOwnership.TransferLocalRef);
		}
...
#pragma warning restore 0169
		...
		public virtual int GetItemCount (int p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				return JNIEnv.CallNonvirtualIntMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getItemCount", "(I)I"), new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public virtual string[] GetTitles (int p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				return (string[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getTitles", "(I)[Ljava/lang/String;"), new JValue (p0)), JniHandleOwnership.TransferLocalRef, typeof (string));
		}
...
#pragma warning restore 0169
		...
		public virtual double[] GetValues (int p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				return (double[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getValues", "(I)[D"), new JValue (p0)), JniHandleOwnership.TransferLocalRef, typeof (double));
		}
...
#pragma warning restore 0169
		...
		public virtual global::Org.Achartengine.Model.XYSeries ToXYSeries ()
		{
			...
			if (GetType () == ThresholdType)
				...
				return global::Java.Lang.Object.GetObject<global::Org.Achartengine.Model.XYSeries> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "toXYSeries", "()Lorg/achartengine/model/XYSeries;")), JniHandleOwnership.TransferLocalRef);
		}
