		...
		public virtual double AngleMax {
			...
			get {
				...
				if (GetType () == ThresholdType)
					...
					return JNIEnv.CallNonvirtualDoubleMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getAngleMax", "()D"));
			}
			...
			set {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setAngleMax", "(D)V"), new JValue (value));
			}
		}
		...
		public virtual double AngleMin {
			...
			get {
				...
				if (GetType () == ThresholdType)
					...
					return JNIEnv.CallNonvirtualDoubleMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getAngleMin", "()D"));
			}
			...
			set {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setAngleMin", "(D)V"), new JValue (value));
			}
		}
		...
		public virtual bool IsMaxValueSet {
			...
			get {
				...
				if (GetType () == ThresholdType)
					...
					return JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "isMaxValueSet", "()Z"));
			}
		}
		...
		public virtual bool IsMinValueSet {
			...
			get {
				...
				if (GetType () == ThresholdType)
					...
					return JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "isMinValueSet", "()Z"));
			}
		}
		...
		public virtual double MajorTicksSpacing {
			...
			get {
				...
				if (GetType () == ThresholdType)
					...
					return JNIEnv.CallNonvirtualDoubleMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getMajorTicksSpacing", "()D"));
			}
			...
			set {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setMajorTicksSpacing", "(D)V"), new JValue (value));
			}
		}
		...
		public virtual double MaxValue {
			...
			set {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setMaxValue", "(D)V"), new JValue (value));
			}
		}
		...
		public virtual double MinValue {
			...
			set {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setMinValue", "(D)V"), new JValue (value));
			}
		}
		...
		public virtual double MinorTicksSpacing {
			...
			get {
				...
				if (GetType () == ThresholdType)
					...
					return JNIEnv.CallNonvirtualDoubleMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getMinorTicksSpacing", "()D"));
			}
			...
			set {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setMinorTicksSpacing", "(D)V"), new JValue (value));
			}
		}
...
#pragma warning restore 0169
		...
		public virtual global::Org.Achartengine.Renderer.DialRenderer.Type GetVisualTypeForIndex (int p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				return global::Java.Lang.Object.GetObject<global::Org.Achartengine.Renderer.DialRenderer.Type> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getVisualTypeForIndex", "(I)Lorg/achartengine/renderer/DialRenderer$Type;"), new JValue (p0)), JniHandleOwnership.TransferLocalRef);
		}
