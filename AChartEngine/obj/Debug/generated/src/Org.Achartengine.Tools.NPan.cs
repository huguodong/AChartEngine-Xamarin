...
namespace Org.Achartengine.Tools {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.achartengine.tools']/class[@name='NPan']"
	[global::Android.Runtime.Register ("org/achartengine/tools/NPan", DoNotGenerateAcw=true)]
	public partial class NPan : global::Org.Achartengine.Tools.AbstractTool {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/achartengine/tools/NPan", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (NPan); }
		}

		protected NPan (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lorg_achartengine_chart_AbstractChart_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.achartengine.tools']/class[@name='NPan']/constructor[@name='NPan' and count(parameter)=1 and parameter[1][@type='org.achartengine.chart.AbstractChart']]"
		[Register (".ctor", "(Lorg/achartengine/chart/AbstractChart;)V", "")]
		public NPan (global::Org.Achartengine.Chart.AbstractChart p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (NPan)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Org.Achartengine.Tools.NPan __this = global::Java.Lang.Object.GetObject<global::Org.Achartengine.Tools.NPan> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.achartengine.tools']/class[@name='NPan']/method[@name='addPanListener' and count(parameter)=1 and parameter[1][@type='org.achartengine.tools.PanListener']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.achartengine.tools']/class[@name='NPan']/method[@name='apply' and count(parameter)=4 and parameter[1][@type='float'] and parameter[2][@type='float'] and parameter[3][@type='float'] and parameter[4][@type='float']]"
		...
		public virtual void Apply (float p0, float p1, float p2, float p3)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "apply", "(FFFF)V"), new JValue (p0), new JValue (p1), new JValue (p2), new JValue (p3));
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.achartengine.tools']/class[@name='NPan']/method[@name='removePanListener' and count(parameter)=1 and parameter[1][@type='org.achartengine.tools.PanListener']]"
