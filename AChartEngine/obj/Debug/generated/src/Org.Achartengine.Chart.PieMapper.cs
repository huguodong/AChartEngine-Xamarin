...
#pragma warning restore 0169
		...
		public virtual void AddPieSegment (int p0, float p1, float p2, float p3)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "addPieSegment", "(IFFF)V"), new JValue (p0), new JValue (p1), new JValue (p2), new JValue (p3));
		}
...
#pragma warning restore 0169
		...
		public virtual bool AreAllSegmentPresent (int p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				return JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "areAllSegmentPresent", "(I)Z"), new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public virtual void ClearPieSegments ()
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "clearPieSegments", "()V"));
		}
...
#pragma warning restore 0169
		...
		public virtual void SetDimensions (int p0, int p1, int p2)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setDimensions", "(III)V"), new JValue (p0), new JValue (p1), new JValue (p2));
		}
