...
#pragma warning restore 0169
		...
		public virtual void AddZoomListener (global::Org.Achartengine.Tools.IZoomListener p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "addZoomListener", "(Lorg/achartengine/tools/ZoomListener;)V"), new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public virtual bool HandleTouch (global::Android.Views.MotionEvent p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				__ret = JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "handleTouch", "(Landroid/view/MotionEvent;)Z"), new JValue (p0));
			return __ret;
		}
