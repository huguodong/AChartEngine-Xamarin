...
#pragma warning restore 0169
		...
		public virtual void CheckRange (double[] p0, int p1)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "checkRange", "([DI)V"), new JValue (native_p0), new JValue (p1));
			if (p0 != null) {
...
#pragma warning restore 0169
		...
		public virtual double[] GetRange (int p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				return (double[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getRange", "(I)[D"), new JValue (p0)), JniHandleOwnership.TransferLocalRef, typeof (double));
		}
...
#pragma warning restore 0169
		...
		protected virtual void SetXRange (double p0, double p1, int p2)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setXRange", "(DDI)V"), new JValue (p0), new JValue (p1), new JValue (p2));
		}
...
#pragma warning restore 0169
		...
		protected virtual void SetYRange (double p0, double p1, int p2)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setYRange", "(DDI)V"), new JValue (p0), new JValue (p1), new JValue (p2));
		}
