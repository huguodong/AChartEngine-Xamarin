...
#pragma warning restore 0169
		...
		public virtual void Add (double p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "add", "(D)V"), new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public virtual void Add (string p0, double p1)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "add", "(Ljava/lang/String;D)V"), new JValue (native_p0), new JValue (p1));
			JNIEnv.DeleteLocalRef (native_p0);
		}
...
#pragma warning restore 0169
		...
		public virtual double GetValue (int p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				return JNIEnv.CallNonvirtualDoubleMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getValue", "(I)D"), new JValue (p0));
		}
...
#pragma warning restore 0169
		...
		public virtual void Set (int p0, string p1, double p2)
		{
			...
			if (GetType () == ThresholdType)
				...
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "set", "(ILjava/lang/String;D)V"), new JValue (p0), new JValue (native_p1), new JValue (p2));
